...
The purpose of this lesson is to go over Python functions and numerical integration.

## Lesson Information
### Lesson Learning Outcomes
This lesson will go over Python functions and numerical integration.

#### Questions
1. What is a function in Python?
2. How can we do non-linear curve fitting?
3. What mathematical functions are appropriate as fitting functions?
4. How can we do numerical integration in Python?

#### Objectives
1. Utilize Python functions.
2. Fit a non-linear curve using Python.
3. Integrate the area under a curve numerically.
